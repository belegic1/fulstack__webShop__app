	...
	return (
		<>
			...
			<div id='content' className='container'>
				<div className='row'>
					<div className='col-sm-4 col-sm-6 single'>
						<div className='product'>
                            ...
                            <div className="text">
                            <h3>
                            <Link to='/product'>Product</Link></h3>
                            <p className="price">€50</p>
                            <p className="buttons">
                            <Link to='/product' className='btn btn-default'>View Details</Link>
                            <Link to='/product' className="btn btn-primary">
                            <i className="fa fa-shopping-cart"></i> Add to cart</Link>
                            </p>
                            </div>
						</div>
					</div>
